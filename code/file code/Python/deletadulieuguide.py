...
# Tạo khung nhập liệu cho việc thêm dữ liệu
frame_insert = tk.Frame(root)
frame_insert.pack(pady=10)

label_temperature = tk.Label(frame_insert, text="Nhập giá trị nhiệt độ:")
...
label_smoke = tk.Label(frame_insert, text="Nhập giá trị khói:")
label_smoke.grid(row=1, column=0, padx=5, pady=5)
entry_smoke = tk.Entry(frame_insert)
entry_smoke.grid(row=1, column=1, padx=5, pady=5)
